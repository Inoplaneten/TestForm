...
const InputFile = props => (
    <label className={classes.fieldUpload}>
        <span className={classes.fieldUpload__info}>
            <svg width="24" height="21" viewBox="0 0 24 21" fill="none" xmlns="http://www.w3.org/2000/svg" className={classes.fieldUpload__icon}>
            ...
            <span className={classes.fieldUpload__text}>
                Add file attach
            </span>
        </span>
        <input 
        ...
        />
        <span className={classes.fieldUpload__counter}>
